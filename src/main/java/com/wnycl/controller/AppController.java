...
//		j.append("temp", "temp");
	...
	public String saveUser(@Valid User user, BindingResult result,
		...
		model.addAttribute("success", "User " + user.getTeamName() + " registered successfully");
		model.addAttribute("loggedinuser", getPrincipal());
		//return "success";
	...
	public String updateUser(@Valid User user, BindingResult result,
		...
		model.addAttribute("success", "User " + user.getTeamName() + " updated successfully");
		model.addAttribute("loggedinuser", getPrincipal());
		return "registrationsuccess";
	}
...
//	    }
	...
	private boolean isCurrentAuthenticationAnonymous() {
	    ...
	    return false;//authenticationTrustResolver.isAnonymous(authentication);
	}
