				...
				<div id="heading-box">
					<div id="heading-box-cnt">
						...
						<div class="featured-main">
							<a href="#"><img src="<c:url value='/css/images/featured-main.jpg' />" alt="" /></a>
						...
						<div class="featured-side">
							...
							<div class="featured-side-item">
								<div class="cl">&nbsp;</div>
								<a href="#" class="left"><img src="<c:url value='/css/images/featured-side-1.jpg' />" alt="" /></a>
							...
							<div class="featured-side-item">
								<div class="cl">&nbsp;</div>
								<a href="#" class="left"><img src="<c:url value='/css/images/featured-side-2.jpg' />" alt="" /></a>
							...
							<div class="featured-side-item">
								<div class="cl">&nbsp;</div>
								<a href="#" class="left"><img src="<c:url value='/css/images/featured-side-3.jpg' />" alt="" /></a>
							...
							<div class="featured-side-item">
								<div class="cl">&nbsp;</div>
								<a href="#" class="left"><img src="<c:url value='/css/images/featured-side-4.jpg' />" alt="" /></a>
		...
		<div class="shell">		
			...
			<div id="content">
				...
				<div class="grey-box">
					...
					<a href="#"><img src="<c:url value='/css/images/main-1.jpg' />" alt="" /></a>
					<p>
				...
				<div class="grey-box">
					...
					<a href="#"><img src="<c:url value='/css/images/main-2.jpg' />" alt="" /></a>
					<p>
						<span>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Curabitur elementum, odio tincidunt egestas</span>
						<a href="#" class="button">Read more</a>
					 </p>
				...
				<div class="grey-box last">
					...
					<a href="#"><img src="<c:url value='/css/images/main-3.jpg' />" alt="" /></a>
					<p>
						<span>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Curabitur elementum, odio tincidunt egestas</span>
						<a href="#" class="button">Read more</a>
					 </p>
				...
				<div class="video-box">
					...
					<div class="video-item-box">
						<a href="#" class="left"><img src="<c:url value='/css/images/video-1.jpg' />" alt="" /></a>
						<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit</p>
						<a href="#" class="watch-now">Watch now</a>
					</div>
					<div class="video-item-box second">
						<a href="#" class="left"><img src="<c:url value='/css/images/video-2.jpg' />" alt="" /></a>
						<p>Curabitur consectetur tellus a diam tincidunt pellentesque</p>
						<a href="#" class="watch-now">Watch now</a>
					</div>
					<div class="video-item-box">
						<a href="#" class="left"><img src="<c:url value='/css/images/video-3.jpg' />" alt="" /></a>
						<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit</p>
						<a href="#" class="watch-now">Watch now</a>
					</div>
					<div class="video-item-box second">
						<a href="#" class="left"><img src="<c:url value='/css/images/video-4.jpg' />" alt="" /></a>
